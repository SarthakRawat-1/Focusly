  ...
  return (
    <Form {...form}>
      <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
        <div className="space-y-8 w-full">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 pb-2 border-b border-border">
              ...
              <h3 className="text-lg font-semibold text-foreground">{t("TIMER")}</h3>
            </div>
          <FormField
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 pb-2 border-b border-border">
              ...
              <h3 className="text-lg font-semibold text-foreground">{t("SOUND")}</h3>
            </div>
        ...
        {/* Action Buttons */}
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end items-center gap-4 pt-6 border-t border-border">
          <Button
          ...
          <Button
            ...
            className="bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary/80 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 w-full sm:w-auto"
            type="submit"
          >
            {isUpdating ? (
