    ...
    <div className="flex flex-col items-center space-y-3">
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button
            className={cn(
              "group relative bg-muted hover:bg-muted/80 w-24 h-24 md:h-28 md:w-28 rounded-full flex justify-center items-center text-muted-foreground overflow-hidden border-4 border-background shadow-lg hover:shadow-xl transition-all duration-300",
              className
            )}
          >
            {profileImage ? (
            ...
            <div className="group-hover:opacity-90 transition-opacity duration-300 opacity-0 w-full h-full absolute bg-black/60 backdrop-blur-sm flex justify-center items-center flex-col gap-2 text-xs text-white">
              <Camera size={24} />
