...
export const Footer = () => {
  return (
    <footer className="w-full bg-background border-t border-border mt-52">
      <div className="container py-4 sm:py-6 max-w-screen-2xl border-t border-border flex flex-col-reverse sm:flex-row sm:justify-between items-center gap-4 px-2 sm:px-4">
        <div className="text-center space-y-0.5 sm:text-left">
          <p className="font-semibold sm:text-lg">
            Made with <span className="text-primary">love</span>
          </p>
          <p className="text-muted-foreground">@ 2024 Focusly</p>
        </div>
