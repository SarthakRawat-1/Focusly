...
export const User = ({ profileImage, username, email }: Props) => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background ml-2 overflow-hidden">
        <UserAvatar 
          className="w-10 h-10" 
